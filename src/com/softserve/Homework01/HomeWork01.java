...
public class HomeWork01 {
    ...
    public static void task1(Scanner console){
        ...
        console.nextLine();
        System.out.println(" Perimeter circle = "+(2*radius*Math.PI));//Don`t forget formatting your code.
        System.out.println(" Area circle = " + (Math.PI*radius*radius)); //If you use library Math, use Math.pow(R,2) instead R*R.
    }
