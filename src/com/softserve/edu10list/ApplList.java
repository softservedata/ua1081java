...
public class ApplList {
    ...
    public static void main(String[] args) {
		...
		*/
        ...
        //lstStr.set(1,"add2222"); // Change 1 to add2222
		lstStr.add("add001");
		lstStr.add("add1111");
		lstStr.add("add010");
        //lstStr.set(8,"add888"); // Runtime Error
        //lstStr.add(8,"add888"); // Ok
        // lstStr.add(9,"add888"); // Runtime Error
		...
		*/
        ...
        //lstStr1.add(new Student(147, "Stepan")); // Runtime Error
		...
		//lstStr.add(1, st1);
        lstStr.add(1, new Student(145, "Stepan"));
