...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.printf("Removal of students because of the average below %s:%n", requiredAvg);
        StudentAssessment.removeStudents(students, requiredAvg);
        System.out.println();
        StudentAssessment.printStudents(students);
